...
class ArtxContentSingleArticle extends ArtxContentItem
{
    ...
    public function printIcon()
    {
        ...
        $text = str_replace('<i class="icon-print', '<i class="cpac-postprinticon', $text);
        return $text;
    }

    public function toc($toc)
    {
        return '<div class="cpac-article">' . $toc . '</div>';
    }

    public function intro($intro)
    {
        return '<div class="cpac-article">' . $intro . '</div>';
    }

    public function text($text)
    {
        return '<div class="cpac-article">' . $text . '</div>';
    }
