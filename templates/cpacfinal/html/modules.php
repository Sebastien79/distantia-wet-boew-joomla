...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'cpac-nostyle';
  $styles = array(
    'cpac-nostyle' => 'modChrome_artnostyle',
    'cpac-block' => 'modChrome_artblock',
    'cpac-article' => 'modChrome_artarticle',
    'cpac-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'cpac-...'        - overwrites the default module style.
  //  'suffix cpac-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add cpac-... to the module elements.
...
<!-- begin nostyle -->
<div class="cpac-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
